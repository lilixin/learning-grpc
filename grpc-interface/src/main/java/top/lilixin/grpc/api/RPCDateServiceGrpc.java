...
@javax.annotation.Generated(
    ...
    comments = "Source: rpcdataservice.proto")
public final class RPCDateServiceGrpc {

  private RPCDateServiceGrpc() {}

  public static final String SERVICE_NAME = "top.lilixin.grpc.api.RPCDateService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<top.lilixin.grpc.api.RPCDateRequest,
      top.lilixin.grpc.api.RPCDateResponse> METHOD_GET_DATE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "top.lilixin.grpc.api.RPCDateService", "getDate"),
          io.grpc.protobuf.ProtoUtils.marshaller(top.lilixin.grpc.api.RPCDateRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(top.lilixin.grpc.api.RPCDateResponse.getDefaultInstance()));
  ...
  public static abstract class RPCDateServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getDate(top.lilixin.grpc.api.RPCDateRequest request,
        io.grpc.stub.StreamObserver<top.lilixin.grpc.api.RPCDateResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                top.lilixin.grpc.api.RPCDateRequest,
                top.lilixin.grpc.api.RPCDateResponse>(
  ...
  public static final class RPCDateServiceBlockingStub extends io.grpc.stub.AbstractStub<RPCDateServiceBlockingStub> {
    ...
    /**
     */
    public top.lilixin.grpc.api.RPCDateResponse getDate(top.lilixin.grpc.api.RPCDateRequest request) {
  ...
  public static final class RPCDateServiceFutureStub extends io.grpc.stub.AbstractStub<RPCDateServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<top.lilixin.grpc.api.RPCDateResponse> getDate(
        top.lilixin.grpc.api.RPCDateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATE:
          serviceImpl.getDate((top.lilixin.grpc.api.RPCDateRequest) request,
              (io.grpc.stub.StreamObserver<top.lilixin.grpc.api.RPCDateResponse>) responseObserver);
          break;
        default:
  ...
  private static final class RPCDateServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return top.lilixin.grpc.api.RPCDateServiceApi.getDescriptor();
    }
  }
